...
export type ThemeName = 'default' | 'blackwhite' | 'sakura' | 'navy' | 'matrix' | 'starry';
...
export const ThemeProvider = ({ children }: { children: ReactNode }) => {
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty('--bg-primary', currentTheme.colors.background);
    ...
    document.documentElement.style.setProperty('--color-correct', currentTheme.colors.correct);
    document.documentElement.style.setProperty('--color-incorrect', currentTheme.colors.incorrect);
    document.documentElement.style.setProperty('--color-accent', currentTheme.colors.accent);
    document.documentElement.style.setProperty('--bg-card', currentTheme.colors.cardBg);
  }, [currentTheme]);
